...
for x in range(prediction_days, len(weather_value)):
    X_train.append(weather_value[x-prediction_days:x, 0])
    y_train.append(weather_value[x, 0])

test_data = weather_value[training_data_len - prediction_days:, :]
X_test = []
